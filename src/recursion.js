...
var sumBelow = function(n) {
  ...
  var numberToSum = n < 0 ? n + 1 : n - 1;
  return numberToSum + sumBelow(numberToSum);
};
...
var palindrome = function(string) {
  var formattedString = string.replace(' ', '').toLowerCase();
  ...
  return palindrome(formattedString.slice(1, -1));
};
